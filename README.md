__IMPORTANT NOTICE: As of Juli 2026 my active personal projects are self-hosted on [code.reboot.li/rebootl](https://code.reboot.li/rebootl). Go check it out!__
